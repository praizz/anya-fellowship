...
export const DefaultLayout: React.FC<DefaultLayoutProps> = (props) => {
  ...
  const drawerWidth = isTablet ? theme.custom.drawerWidth.tablet : theme.custom.drawerWidth.desktop;
    ...
    <Box sx={{ display: "flex" }}>
      ...
      <AppBar
        ...
        sx={{
          ...
          backgroundColor: alpha(theme.palette.primary.dark, theme.custom.opacity.darker),
